    ...
    edit_recipient:function(id){
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                var kpi_list='<div class="checkbox select_all float-left mb-4 mr-2"><label><input id="select_all" name="select_all" type="checkbox"> <b>'+Lang.get('js_msgs.select_all')+'</b></label></div><a href="#" class=" undoselection_btn"> '+Lang.get('js_msgs.undo_selection')+'</a>';
                var selected;
