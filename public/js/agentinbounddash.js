...
var Dashboard = {
    ...
    get_call_volume:function(datefilter, chartColors){
        ...
        $.ajax({
            async: true,
            url: '/agentinbounddashboard/call_volume',
            type: 'POST',
            dataType: 'json',
            data:{
    ...
    get_total_conversions:function(datefilter){
        ...
        $.ajax({
            async: true,
            url: '/agentinbounddashboard/get_sales',
            type: 'POST',
            dataType: 'json',
            data:{
                datefilter:datefilter
    ...
    rep_performance:function(datefilter, chartColors){
        ...
        $.ajax({
            async: true,
            url: '/agentinbounddashboard/rep_performance',
            type: 'POST',
            dataType: 'json',
            data:{
                datefilter:datefilter
    ...
    call_status_count:function(datefilter, chartColors){
        ...
        $.ajax({
            async: true,
            url: '/agentinbounddashboard/call_status_count',
            type: 'POST',
            dataType: 'json',
    ...
    update_datefilter:function(datefilter){
        ...
        $.ajax({
            async: true,
            url: '/agentinbounddashboard/update_filters',
            type: 'POST',
            dataType: 'json',
            data: {datefilter: datefilter},
            success:function(response){
