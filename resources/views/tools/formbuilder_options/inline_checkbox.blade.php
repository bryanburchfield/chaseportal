<div class="options options-inline_checkbox form-horizontal">
    <div class="form-group">
        <label class="control-label col-sm-3">Name</label>
        <div class="controls col-sm-9">
            <input type="text" class="options_inline_checkbox_name form-control" placeholder="Name">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="controls col-sm-9">
            <input type="text" class="options_inline_checkbox_label form-control" placeholder="Label">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="controls col-sm-9">
            <textarea class="options_inline_checkbox_options form-control" placeholder="Options"></textarea>
