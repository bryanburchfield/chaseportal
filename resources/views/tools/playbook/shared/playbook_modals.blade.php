        ...
        <div class="modal-content">
            ...
            <form action="#" method="post" class="form edit_playbook">
                ...
                <div class="modal-footer">
                    <a href="#" class="btn btn-danger flt_lft delete_playbook_modal fw600" data-id="{{$contacts_playbook->id}}" data-toggle="modal" data-target="#deletePlaybookModal"><i class="fas fa-trash-alt"></i> {{__('tools.delete_playbook')}}</a>
