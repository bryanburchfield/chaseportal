                            ...
                            <tr>
                                <td>
                                    <div class="text" style="text-align: center;">
                                        <h2 style="color:#ffffff;"><span>INTERNAL SPAM CHECK REPORT</span> <br>{{ $data['startdate'] }}<br>{{ $data['period'] }}</h2>
                                    </div>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td>
                                    <table width='45%' cellpadding='0' cellspacing='0' border='0' align='left' class='deviceWidth'>
                                        <tr>
                                            <td valign='top' style='font-size: 11px; color: #f1f1f1; color:#999; font-family: Arial, sans-serif; ' class='center pb0'>

                                                <address class="mb10" style='line-height:17px;text-decoration: none; color: #ddd; font-weight: normal; font-style: normal;font-size: 12px;'>
                                                    8201 Peters Rd Ste, 1000 <br />Plantation, FL 33324<br />(888) 739-8218
                                                </address>

                                                <a href='mailto:sales@chasedatacorp.com' class="mt15" style='font-size: 12px;text-decoration: none; color: #ddd; font-weight: normal;'>sales@chasedatacorp.com</a>
                                    ...
                                    <table width='40%' cellpadding='0' cellspacing='0' border='0' align='right' class='deviceWidth'>
                                        <tr>
                                            <td valign='top' style='font-size: 11px; color: #f1f1f1; font-weight: normal; font-family: Georgia, Times, serif; line-height: 26px; vertical-align: top; text-align:right' class='center'>
                                                ...
                                                <a href='https://www.facebook.com/ChaseDataCorp/'><img src='{{ $data['url'] }}img/facebook.png' width='32' height='32' alt='Facebook' title='Facebook' border='0' /></a>

                                                <a class="ml10" href='https://www.youtube.com/channel/UCGm2112RvM7ws3GrIq2HoPg'><img src='{{ $data['url'] }}img/youtube.png' width='32' height='32' alt='You Tube' title='You Tube' border='0' /></a>

                                                <a class="ml10" href='https://www.linkedin.com/company/chase-data-corp/'><img src='{{ $data['url'] }}img/linkedin.png' width='32' height='32' alt='Linkedin' title='Linkedin' border='0' /></a>

                                                <a class='mt10 pr20' style='display: block;' href='#'><img width='160px' src='{{ $data['url'] }}img/logo-footer.png' alt='' border='0' class='pt5' /></a><br />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
