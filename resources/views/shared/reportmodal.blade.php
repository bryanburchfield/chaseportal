    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @php
                    $reports = [
                        ...
                        'callerid_swaps' => __('reports.callerid_swaps'),
                    ...
                    if (Auth::User()->group_id == 224802) {
                        ...
                        $reports['apn_production_report'] = __('reports.production_report');
                    }
                ...
                <div class="col-sm-6 p0">
                    @foreach ($list1 as $key => $value)
                        <div class="radio">
                            <label><input type="radio" name="report_option" class="report_option"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default mr10 flt_lft"
