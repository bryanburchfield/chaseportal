<nav id="sidebar" class="active">
    ...
    <ul class="list-unstyled components">
        ...
        <li data-page="dashboards" <?php echo !empty($page['menuitem']) && $page['menuitem'] == 'dashboards' ? 'class="active"' : ''?> ><a href="#" class="update_nav_link" data-path="dashboards"><i class="fas fa-chart-line"></i>{{__('sidenav.dashboards')}}</a></li>
