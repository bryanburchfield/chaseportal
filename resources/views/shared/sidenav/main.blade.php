...
@section('sidenav')
    <li data-page="dashboards" <?php echo !empty($page['menuitem']) && $page['menuitem'] == 'dashboards' ? 'class="active"' : ''?>><a href="#" class="update_nav_link" data-path="dashboards"><i class="fas fa-chart-bar"></i>{{__('sidenav.dashboards')}}</a></li>
