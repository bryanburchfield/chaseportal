...
@section('sidenav')
    ...
    @can('accessSuperAdmin')
        ...
        <li data-page="form_builder" @php echo !empty($page['menuitem']) && $page['menuitem']== 'form_builder' ? 'class="active"' : ''; @endphp><a href="{{ action('FormBuilderController@index') }}"><i class="fas fa-wrench"></i> {{__('sidenav.form_builder')}}</a></li>
    @endcan
@endsection
