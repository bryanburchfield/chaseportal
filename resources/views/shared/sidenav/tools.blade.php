...
@section('sidenav')
    ...
    <li data-page="lead_detail" @php echo !empty($page['menuitem']) && $page['menuitem']== 'lead_detail' ? 'class="active"' : ''; @endphp><a href="{{action('LeadsController@leadDetail')}}"><i class="fas fa-search"></i>{{__('tools.lead_detail')}}</a></li>
