<nav id="sidebar" class="active">
    ...
    <ul class="list-unstyled components">
        ...
        @can('accessSuperAdmin')
            ...
            <li data-page="settings" @php echo !empty($page['menuitem']) && $page['menuitem']== 'settings' ? 'class="active"' : ''; @endphp><a href="{{ action('AdminController@settings') }}"><i class="fas fa-link"></i> {{__('widgets.edit_myself')}}</a></li>
