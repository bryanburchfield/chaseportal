        ...
        <div class="row">
            ...
            <div class="col-sm-12 opt" data-kpi="{{ $kpi->id }}">
                ...
                <div class="controls">
                    ...
                    <a href="https://webdev.chasedatacorp.com/kpi/crons/cron_{{ $kpi->id }}.php?interval={{ $kpi->interval}}"
                        class="run_kpi btn btn-default btn-sm"><span class="glyphicon glyphicon-flash"></span> Run KPI</a>
                    ...
                    <div class="row mt-3 options">
                        <div class="col-sm-6">
                            ...
                            <div class="expanded_options clear">
                                <form data-kpi="{{ $kpi->id }}" action="#" method="post"
                                    class="form well adjust_interval">
                                    <div class="form-group">
                                        <label for="type">Interval</label>
                                        <select name="interval" id="interval" class="form-control interval" required>
                                            <option>Choose One</option>
                                            <option {!! $kpi->interval == '15' ? ' selected="selected"' : '' !!}
                                                value="15">Every 15 minutes</option>
                                            <option {!! $kpi->interval == '30' ? ' selected="selected"' : '' !!}
                                                value="30">Every 30 minutes</option>
                                            <option {!! $kpi->interval == '60' ? ' selected="selected"' : '' !!}
                                                value="60">Every Hour</option>
                                            <option {!! $kpi->interval == '720' ? ' selected="selected"' : '' !!}
                                                value="720">Twice a Day</option>
                                            <option {!! $kpi->interval == '1440' ? ' selected="selected"' : '' !!}
                                                value="1440">Once a Day</option>
                                        </select>
                                    </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="expanded_emails clear">
                                <a href="#" class="add_email"><i class="glyphicon glyphicon-plus-sign"></i> Add
                                    Recipient</a>

                                <form id="form{{ $kpi->id}}" data-kpi="{{ $kpi->id }}" action="#" method="post"
                                    class="form user_email_form well clear add_recipient" autocomplete="off">
                                    <div class="form-group prel">
                                        <input type="text" class="form-control name" name="name" placeholder="Name"
                                            required onkeyup="searchRecips(this, this.value, '{{ $kpi->id }}')"
                                    ...
                                    <div class="checkbox mb20">
                                        <label><input type="checkbox" class="addtoall" name="addtoall" value="1">Add
                                            recipient to all KPI's?</label>
                                    </div>
