						...
						<div class="mt20">
							...
							<div class="tab-content">
								<div class="tab-pane active mt30" id="new_user">
									<div class="col-sm-6 mb0 card">
										...
										{!! Form::open(['method'=>'POST', 'url'=>'/dashboards/add_user', 'class'=>'form
										add_user']) !!}
										<div class="form-group">
											{!! Form::label('group_id', 'Group ID') !!}
											{!! Form::text('group_id', null, ['class'=>'form-control group_id',
											'required'=>true]) !!}
										</div>
										...
										<div class="form-group">
											...
											{!! Form::select("tz", $timezone_array, null, ["class" => "form-control",
											'id'=> 'tz', 'required'=>true]) !!}
										</div>
										...
										<div class="form-group">
											...
											{!! Form::select("additional_dbs", $dbs, null, ["class" => "form-control",
											'id'=> 'additional_dbs']) !!}
										</div>
										...
										<div class="users">
											...
											<div class="panel-group" id="add_accordion" role="tablist"
												...
												for($i=1; $i<=25;$i++){ if($db <10){ $db='0' . $db; } @endphp <div
													...
													<div id="add_dialer{{$db}}" class="panel-collapse collapse"
														role="tabpanel" aria-labelledby="add_heading{{$db}}">
							...
							<div class="tab-pane mt30" id="edit_user">
								<div class="col-sm-6 card">
									...
									{!! Form::open(['method'=>'POST', 'url'=>'/dashboards/edit_user', 'class'=>'form
									edit_user']) !!}
									<div class="form-group">
										{!! Form::label('group_id', 'Group ID') !!}
										{!! Form::text('group_id', null, ['class'=>'form-control group_id',
									...
									<div class="form-group">
										{!! Form::label('tz', 'Timezone') !!}
										{!! Form::select("tz", $timezone_array, null, ["class" => "form-control", 'id'=>
										'tz', 'required'=>true]) !!}
									</div>
										...
										<div class="panel-group" id="edit_accordion" role="tablist"
											...
											for($i=1; $i<=25;$i++){ if($db <10){ $db='0' . $db; } @endphp <div
												...
												<div class="panel-heading" role="tab" id="edit_heading{{$db}}">
													<h4 class="panel-title">
														<a class="collapsed" role="button" data-toggle="collapse"
															data-parent="#edit_accordion" href="#edit_dialer{{$db}}"
															aria-expanded="false" aria-controls="edit_dialer{{$db}}">
															Dialer {{$db}}
														</a>
													</h4>
												</div>
												<div id="edit_dialer{{$db}}" class="panel-collapse collapse"
													role="tabpanel" aria-labelledby="edit_heading{{$db}}">
													<div class="panel-body">
														<table class="table table-responsive table-striped">
															<thead>
																<tr>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body user_links_modal">
				...
				<a data-toggle="tooltip" title="Link Copied!" href="#"
					class="getAppToken">{{url('/')}}/agentdashboard/api/<span class="url_token"></span>/(#Rep#)</a>
				<a data-toggle="tooltip" title="Link Copied!" href="#"
					class="getAppToken">{{url('/')}}/agentoutbounddashboard/api/<span
						class="url_token"></span>/(#Rep#)</a>
				<a data-toggle="tooltip" title="Link Copied!" href="#"
					class="getAppToken">{{url('/')}}/admindashboard/api/<span class="url_token"></span></a>
				<a data-toggle="tooltip" title="Link Copied!" href="#"
					class="getAppToken">{{url('/')}}/adminoutbounddashboard/api/<span class="url_token"></span></a>
				<a data-toggle="tooltip" title="Link Copied!" href="#"
					class="getAppToken">{{url('/')}}/leaderdashboard/api/<span class="url_token"></span></a>
				<a data-toggle="tooltip" title="Link Copied!" href="#"
					class="getAppToken">{{url('/')}}/trenddashboard/api/<span class="url_token"></span></a>
