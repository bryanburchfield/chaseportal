    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body user_links_modal">
				...
				<h4><span class="dash_type">Lead Lookup Dashboard</span> -<a data-toggle="tooltip"  title={{__('users.link_copied')}} href="#" class="getAppToken">{{url('/')}}/tools/agentleaddetail/api/<span class="url_token"></span></a></h4>
