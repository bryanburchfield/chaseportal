...
return [
    ...
    'callerid_swaps_1' => 'This report lists all CallerIDs that have been replaced because they were flagged as spam.',
    'callerid_swaps_2' => 'The number of calls and connect percentage looks back at the previous 30 days.',
    'callerid_swaps_3' => 'Connects are calls that went through, which not necessarily the same as what the client configured as a "connect".',
    ...
    'flagged' => 'Indicates the CallerID flagged as spam',
    ...
    'owned' => 'Inidicates the CallerID is Owned',
    ...
    'replaced_by' => 'The CallerID that replaced the original',
